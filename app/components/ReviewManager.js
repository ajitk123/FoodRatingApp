...
export const ReviewManager = ({ reviews, userId }) => {
  ...
  const handleAddReview = useCallback(
    (firstName, lastName, restaurant, vegRating, description, latitude, longitude, address) => {
      if (!vegRating || !description || !restaurant) {
        return;
      }
      realm.write(() => {
        realm.create(
    ...
    <SafeAreaView style={styles.content}>
      ...
      >
        <AddTaskForm
          ...
          visibleControl={setModalVisible}
        />
      </Modal>
      <View style={styles.taskList}>
        <ReviewList
          currentUser={userId}
          reviews={reviews}
          onDeleteTask={handleDeleteReview}
        />
      </View>
      <Pressable
